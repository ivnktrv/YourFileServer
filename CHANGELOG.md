...
- Возможность создавать, менять имя, удалять папки и перемещать файлы в какую либо папку
- Авторизация к серверу либо по логину и паролю, либо по ssh ключю (тут уже что я выберу, не ждите что оба варианта будут доступны, хотя если получится, то добавлю и то и то : /)
